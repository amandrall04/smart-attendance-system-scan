...
import { confirmAttendance, getStudents, saveFaceDescriptor, markStudentTrained, getAllFaceDescriptors, getUntrainedStudents } from './api';
import './style.css';
...
function App() {
  ...
  const fetchUntrainedStudents = async () => {
    try {
      const response = await fetch('http://localhost:5001/api/students/untrained');
